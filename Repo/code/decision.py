...
def decision_step(Rover):
    ...
    offset = 0
    # Only apply right wall hugging when out of the starting point (after 10s)
    ...
    if Rover.nav_angles is not None:
        ...
        if Rover.mode[-1] == 'forward':
            ...
            # if sample rock on sight (in the right side only) and relatively close
            ...
            # Check the extent of navigable terrain
                ...
                # Hug right wall by setting the steer angle slightly to the right
            ...
            # Now we're stopped and we have vision data to see if there's a path forward
                ...
                # Since hugging right wall steering should be to the right:
                Rover.steer = 15
                Rover.stuck_time = Rover.total_time
