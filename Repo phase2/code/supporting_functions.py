...
def update_rover(Rover, data):
    ...
    print('speed =', Rover.vel, 'position =', Rover.pos, 'throttle =',
          ...
          'samples collected:', Rover.samples_collected, "sample distance",Rover.samples_dists,"sample angle",Rover.samples_angles, Rover.mode)
...
def create_output_images(Rover):
    ...
    cv2.putText(map_add, "  Collected: "+str(Rover.samples_collected), (0, 85),
                cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
    cv2.putText(map_add, "  Mode: "+str(Rover.total_time - Rover.stuck_time), (0, 100),
                cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
    # cv2.putText(map_add, "  Mode: "+str(Rover.mode[-1]), (0, 100),
    #             cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
